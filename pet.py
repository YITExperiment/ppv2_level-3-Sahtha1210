...
eye_left = c.create_oval(130, 110, 160, 170, outline='gold', fill='gold')
pupil_left = c.create_oval(140, 145, 150, 155, outline='white', fill='white')
eye_right = c.create_oval(230, 110, 260, 170, outline='black', fill='black')
pupil_right = c.create_oval(240, 145, 250, 155, outline='blue', fill='blue')
